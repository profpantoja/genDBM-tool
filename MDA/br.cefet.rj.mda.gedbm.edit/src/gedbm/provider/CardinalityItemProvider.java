...
/**
 * This is the item provider adapter for a {@link gedbm.Cardinality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cardinality_limit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cardinality_limit_feature", "_UI_Cardinality_type"),
				 GedbmPackage.Literals.CARDINALITY__LIMIT,
				 true,
				 false,
				 false,
	...
	protected void addReferentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cardinality_referent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cardinality_referent_feature", "_UI_Cardinality_type"),
				 GedbmPackage.Literals.CARDINALITY__REFERENT,
				 true,
				 false,
				 true,
				 null,
