...
/**
 * This is the item provider adapter for a {@link gedbm.Check} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GedbmPackage.Literals.CHECK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Check_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Check_condition_feature", "_UI_Check_type"),
				 GedbmPackage.Literals.CHECK__CONDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
