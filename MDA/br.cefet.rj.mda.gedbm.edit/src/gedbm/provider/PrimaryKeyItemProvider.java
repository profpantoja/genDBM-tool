...
/**
 * This is the item provider adapter for a {@link gedbm.PrimaryKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimaryKey_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKey_name_feature", "_UI_PrimaryKey_type"),
				 GedbmPackage.Literals.PRIMARY_KEY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsPrimaryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimaryKey_isPrimary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKey_isPrimary_feature", "_UI_PrimaryKey_type"),
				 GedbmPackage.Literals.PRIMARY_KEY__IS_PRIMARY,
				 true,
				 false,
				 true,
				 null,
