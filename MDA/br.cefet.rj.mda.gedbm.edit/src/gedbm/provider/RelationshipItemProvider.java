...
/**
 * This is the item provider adapter for a {@link gedbm.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GedbmPackage.Literals.RELATIONSHIP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsAssociativePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_isAssociative_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_isAssociative_feature", "_UI_Relationship_type"),
				 GedbmPackage.Literals.RELATIONSHIP__IS_ASSOCIATIVE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Entity relation name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEntity_relation_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_entity_relation_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_entity_relation_name_feature", "_UI_Relationship_type"),
				 GedbmPackage.Literals.RELATIONSHIP__ENTITY_RELATION_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GedbmPackage.Literals.RELATIONSHIP__IS_CONSTRAINT);
			childrenFeatures.add(GedbmPackage.Literals.RELATIONSHIP__IS_MAPPING);
			childrenFeatures.add(GedbmPackage.Literals.RELATIONSHIP__WOULD_HAS_PRIMARY);
			childrenFeatures.add(GedbmPackage.Literals.RELATIONSHIP__WOULD_HAS_FOREIGN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GedbmPackage.Literals.RELATIONSHIP__IS_CONSTRAINT,
				 GedbmFactory.eINSTANCE.createCardinality()));

		newChildDescriptors.add
			(createChildParameter
				(GedbmPackage.Literals.RELATIONSHIP__IS_MAPPING,
				 GedbmFactory.eINSTANCE.createField()));

		newChildDescriptors.add
			(createChildParameter
				(GedbmPackage.Literals.RELATIONSHIP__WOULD_HAS_PRIMARY,
				 GedbmFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(GedbmPackage.Literals.RELATIONSHIP__WOULD_HAS_FOREIGN,
				 GedbmFactory.eINSTANCE.createForeignKey()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return GedbmEditPlugin.INSTANCE;
	}
