...
/**
 * This is the item provider adapter for a {@link gedbm.DataBase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataBaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GedbmPackage.Literals.DATA_BASE__NAME,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GedbmPackage.Literals.DATA_BASE__IS_COMPOSED,
				 GedbmFactory.eINSTANCE.createEntity()));

		newChildDescriptors.add
			(createChildParameter
				(GedbmPackage.Literals.DATA_BASE__HAS_INTERACTION,
				 GedbmFactory.eINSTANCE.createRelationship()));
	}
