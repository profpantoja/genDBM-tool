...
/**
 * This is the item provider adapter for a {@link gedbm.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForeignKeyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GedbmPackage.Literals.FOREIGN_KEY__REFERS_TO,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Is Foreign feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsForeignPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForeignKey_isForeign_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForeignKey_isForeign_feature", "_UI_ForeignKey_type"),
				 GedbmPackage.Literals.FOREIGN_KEY__IS_FOREIGN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForeignKey_References_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForeignKey_References_feature", "_UI_ForeignKey_type"),
				 GedbmPackage.Literals.FOREIGN_KEY__REFERENCES,
				 true,
				 false,
				 true,
				 null,
