...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Text Limit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class TextLimitImpl extends MinimalEObjectImpl.Container implements TextLimit {
	...
	protected EClass eStaticClass() {
		return GedbmPackage.Literals.TEXT_LIMIT;
	}
	...
	public void setSize(int newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GedbmPackage.TEXT_LIMIT__SIZE, oldSize, size));
	}
