...
import gedbm.diagram.part.GedbmDiagramEditor;
 ...
 * @generated
 */
public class GedbmNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof GedbmNavigatorItem) {
					selectedElement = ((GedbmNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, GedbmDiagramEditor.ID);
