 ...
 * @generated
 */
public class RelationshipIsMappingReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RelationshipIsMappingReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Field && newEnd instanceof Relationship)) {
			return false;
		}
		return GedbmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipIsMapping_4003(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GedbmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipIsMapping_4003(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getIsMapping().remove(getOldTarget());
		getNewSource().getIsMapping().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getIsMapping().remove(getOldTarget());
		getOldSource().getIsMapping().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
