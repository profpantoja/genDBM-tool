 ...
 * @generated
 */
public class EntitySubgroupOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EntitySubgroupOfReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return GedbmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntitySubgroupOf_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GedbmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntitySubgroupOf_4004(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setSubgroupOf(null);
		getNewSource().setSubgroupOf(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setSubgroupOf(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
