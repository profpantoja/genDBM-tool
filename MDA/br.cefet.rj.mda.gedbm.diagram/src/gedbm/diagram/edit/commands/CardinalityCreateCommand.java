 ...
 * @generated
 */
public class CardinalityCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CardinalityCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GedbmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCardinality_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Cardinality newElement = GedbmFactory.eINSTANCE.createCardinality();
		getSource().getIsConstraint().add(newElement);
		newElement.setReferent(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(Cardinality newElement,
