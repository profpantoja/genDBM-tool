...
import gedbm.diagram.edit.policies.GedbmTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CardinalityLimitEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				GedbmVisualIDRegistry
						.getType(gedbm.diagram.edit.parts.CardinalityLimitEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CardinalityLimitEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new GedbmTextSelectionEditPolicy());
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					GedbmEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
