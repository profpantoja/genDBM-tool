...
import gedbm.diagram.edit.commands.RelationshipIsMappingCreateCommand;
import gedbm.diagram.edit.commands.RelationshipIsMappingReorientCommand;
 ...
 * @generated
 */
public class FieldItemSemanticEditPolicy extends
	...
	public FieldItemSemanticEditPolicy() {
		super(GedbmElementTypes.Field_2003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (GedbmVisualIDRegistry.getVisualID(incomingLink) == EntityIsComposedEditPart.VISUAL_ID) {
			...
			if (GedbmVisualIDRegistry.getVisualID(incomingLink) == RelationshipIsMappingEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (GedbmElementTypes.RelationshipIsMapping_4003 == req
				.getElementType()) {
			return null;
		}
		return null;
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (GedbmElementTypes.RelationshipIsMapping_4003 == req
				.getElementType()) {
			return getGEFWrapper(new RelationshipIsMappingCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case RelationshipIsMappingEditPart.VISUAL_ID:
			return getGEFWrapper(new RelationshipIsMappingReorientCommand(req));
		}
