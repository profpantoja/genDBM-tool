...
public class RelationshipItemSemanticEditPolicy extends
	...
	public RelationshipItemSemanticEditPolicy() {
		super(GedbmElementTypes.Relationship_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (GedbmVisualIDRegistry.getVisualID(outgoingLink) == CardinalityEditPart.VISUAL_ID) {
			...
			if (GedbmVisualIDRegistry.getVisualID(outgoingLink) == RelationshipIsMappingEditPart.VISUAL_ID) {
